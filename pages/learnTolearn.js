  ...
  return (
    <div className={styles.container}>
      ...
      <main>
        ...
        <div className={styles.mainContent}>
        What I'm pertaining to is a protocol for learning. A system, per se, for undertaking a subject/discipline and using the aforementioned protocol to assist in the perspicacity and digestion of its inherent contents. 
        </div>
        ...
        <div className={styles.mainContent}>
        Relevance is integral toward informing the brain on why it is you are doing what you are doing (in terms of learning). I remember many times on my journey, setting out to learn a function or construct (such as Database models) and not knowing the relevance/purpose behind why a function or model is required. How do they tie into the bigger picture? What is the bigger picture? These were a few of the many questions my mind was asking itself. I realised very early on that if i was without ‘Relevance’ then I would quickly forget the subject I had recently studied. Having said that, ‘Relevance’ can take some time to acquire (depending on the subject matter). The reason is complex subjects have many moving parts or a large variety of small pieces to a very large puzzle. Eventually, the more pieces of the puzzle you put together, the clearer the bigger picture becomes…. Hence the Relevance…. 

        A lot of material you find in the wild will tell you the ‘How’. In terms of Relevance, you will want to know the ‘Why’. i.e. why am I creating a function or a model and what role does the function or model play. 
        ...
        <div className={styles.mainContent}>
        The ‘Explanation’ will introduce new concepts to the mind in a detailed way. This is pertinent to refer back to even though at the time of hearing the explanation some parts (maybe more than others) may not make sense.  
        </div>
        ...
        <div className={styles.mainContent}>
        Deduction is one of my personal favourites. Many times I have studied videos on the internet and the content creator has made a mistake and corrected themselves thereafter. In this moment I realised that seeing how something should not be carried out allows the mind to deduce on how it is that it can only be carried out. In other words, by learning how a construct cannot be applied, will help refine the knowledge of a construct can only be applied. The ‘How not to do’, (as I call it) has helped me significantly in learning the fine details of any given subject. I’m always asking myself: ‘How can this not work…. What are its inherent limitations’.   
        </div>
        <div className={styles.subjectTitle}>
            Dive In
        </div>
        <div className={styles.mainContent}>
        Dive in and start doing (kinesthetic learning) is the one of the most proficient ways to pick up a new subject. Coupled with the prerequisite steps of the protocol, you will be more than ready to roll your sleeves up and travel into ‘key-stroke heaven’. Ok… ok… In truth this requires patience, discipline and practice. The harder and smarter you work at this stage will define the outcome. ‘You get out what you put in’. As simple as that! Having said that, work smart and take breaks often. Your brain only starts to assimilate the newly acquired knowledge and compartmentalise whilst you are resting. Close your eyes for 20 minutes and recharge the mind. We all know how the day goes (cognitively speaking) when we have less sleep than usual. I would also like to mention that parts of our brain work independently at times. To elaborate, when we are learning ‘Syntax’ for a new programming language, the logical mind takes a back seat. The part of your brain that works on memory moves to the forefront to pick up on the syntax. So when trying to iterate over a list or carry out some logic in the initial stages it will feel like you have forgotten how to count as you are primarily focused on the correct syntax. I actually forgot how to spell (for a brief period) during my time learning the syntax for Javascript. In other words, the brain utilises a method known as the ‘separation of concerns’. Only once you have the syntax embedded, does the logical mind come into full force. It takes time, although with enough practice you will receive your ‘aha’ moment. 
